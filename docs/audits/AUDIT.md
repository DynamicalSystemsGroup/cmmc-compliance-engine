...
*Fix (10 minutes):* add a banner to each: " Historical design note (pre-implementation). For what actually exists, see `docs/AS-BUILT.md`." Better: delete them — AS-BUILT's component map already does their job accurately.
