...
from compliance_engine.ontology.prefixes import CMMC, CE  # noqa: F401  (CE re-exported for the compiler)

# Repo root = this file's grandparent (order-compiler/ -> repo root).
_REPO_ROOT = Path(__file__).resolve().parent.parent.parent.parent
_CATALOG_TTL = _REPO_ROOT / "data" / "ontology" / "cmmc-edit.ttl"
...
# ---------------------------------------------------------------------------
_OBLIGATIONS_TTL = _REPO_ROOT / "src" / "compliance_engine" / "order_compiler" / "obligations.ttl"
