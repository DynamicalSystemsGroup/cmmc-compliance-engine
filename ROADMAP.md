...
- [ ] Author `ontology/cmmc-edit.ttl` from the **Control Catalog** — all 110 controls, weights, POA&M flags. *Highest-leverage day: Document 1 becomes Turtle.*
...
**Exit:** an Order for NV012 is *compiled* (not hand-written) and passes Gate 1; the Factory runs it end-to-end.
